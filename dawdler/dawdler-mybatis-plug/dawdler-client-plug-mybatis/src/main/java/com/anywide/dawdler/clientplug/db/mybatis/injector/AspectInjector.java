 ...
 */
package com.anywide.dawdler.clientplug.db.mybatis.injector;
...
public class AspectInjector implements CustomComponentInjector {
	...
	public String[] scanLocations() {
		return new String[] { "com.anywide.dawdler.clientplug.db.mybatis", "com.anywide.dawdler.core.db.mybatis" };
	}
