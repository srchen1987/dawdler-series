 ...
 */
package club.dawdler.serverplug.service.impl;

import club.dawdler.serverplug.bean.XmlBean;
import club.dawdler.serverplug.load.ReadClass;
import club.dawdler.serverplug.service.CheckUpdate;
import club.dawdler.util.XmlObject;

/**
 * @author jackson.song
 * @version V1.0
 * 用于获取更新服务器端模版类列表的服务实现
 */
