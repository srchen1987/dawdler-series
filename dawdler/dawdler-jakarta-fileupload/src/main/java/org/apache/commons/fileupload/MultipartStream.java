...
public class MultipartStream {
	...
	/**
	 * <p>
	 * Constructs a <code>MultipartStream</code> with a custom size buffer and no
	 * progress notifier.
	 *
	 * <p>
	 ...
	 *                                  the size limits
	 * @throws MalformedStreamException if the stream ends unexpectedly or fails to
	...
	public class ItemInputStream extends InputStream implements Closeable {
		...
		/**
		 * The number of bytes, which must be hold, because they might be a part of the
		 * boundary.
		 */
		private int pad;
