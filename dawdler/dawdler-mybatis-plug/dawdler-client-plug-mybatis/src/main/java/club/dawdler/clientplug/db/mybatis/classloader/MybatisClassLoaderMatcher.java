 ...
 */
package club.dawdler.clientplug.db.mybatis.classloader;
...
public class MybatisClassLoaderMatcher implements DawdlerClassLoaderMatcher{
	...
	public String[] matchPackageName() {
		return new String[] {"org.apache.ibatis","club.dawdler.core.db.mybatis","club.dawdler.clientplug.db.mybatis"};
	}
