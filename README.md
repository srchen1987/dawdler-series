...
![version](https://img.shields.io/badge/dawdler--series-0.1.3--jdk21--RELEASES-brightgreen)&nbsp;
...
dawdler为分布式调用微服务而生,因此项目的结构也是以服务提供者->调用者(webapi提供者)这种方式构建的(请自行了解服务拆分原则,不在此进行说明).
