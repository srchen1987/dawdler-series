...
public interface DeployClassLoader extends Closeable {
	...
	default void definePackageInnner(String pkgname, Manifest man, URL url) {
		if (getAndVerifyPackageInnner(pkgname, man, url) == null) {
			try {
				if (man != null) {
	...
	default Package getAndVerifyPackageInnner(String pkgname, Manifest man, URL url) {
