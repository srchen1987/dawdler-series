...
### dawdler模块介绍(具体文档可以点击连接进入子模块有详细说明)
...
#### 27.  [dawdler-mybatis-core](dawdler/dawdler-mybatis-core/README.md)

通过mybatis3.5.6进行改造,session变更为单例模式,支持读写分离,去除cache功能,一般不会单独使用,由dawdler-server-plug-mybatis依赖引入此模块即可.

#### 28. [dawdler-client-api-generator](dawdler/dawdler-client-api-generator/README.md)
