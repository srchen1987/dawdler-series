...
public final class AlgorithmFactory {
	...
	private static final Set<String> HMAC_ALGORITHMS = Collections
			.unmodifiableSet(new HashSet<>(Arrays.asList("HS256", "HS384", "HS512")));
	private static final Set<String> RSA_ALGORITHMS = Collections
			.unmodifiableSet(new HashSet<>(Arrays.asList("RS256", "RS384", "RS512")));
