 ...
 *
 * <p>
 * This interface need to implements at an SQL provider class and it need to
 * define the default constructor for creating a new instance.
 *
 * @since 3.5.1
...
public interface ProviderMethodResolver {
	 ...
	 * <li>Return type matches the {@link CharSequence}({@link String},
	 * {@link StringBuilder}, etc...)</li>
	 * </ul>
	...
	default Method resolveMethod(ProviderContext context) {
		...
		if (sameNameMethods.isEmpty()) {
			throw new BuilderException(
					"Cannot resolve the provider method because '" + context.getMapperMethod().getName()
