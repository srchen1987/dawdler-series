...
public class FileUploadException extends Exception {
	...
	/**
	 * The exceptions cause. We overwrite the cause of the super class, which isn't
	 * available in Java 1.3.
	 */
	...
	/**
	 * Creates a new <code>FileUploadException</code> with the given detail message
	 * and cause.
	 *
