...
public interface FileItemHeaders {
	 ...
	 * return <code>null</code>. If there are multiple headers with the same name,
	 ...
	 *         or <code>null</code> if the item does not have a header of that name
	 */
	 ...
	 * returns an empty <code>Iterator</code>. The header name is case insensitive.
	 * </p>
	 *
	 * @param name a <code>String</code> specifying the header name
	 * @return an <code>Iterator</code> containing the values of the requested
	 *         header. If the item does not have any headers of that name, return an
	 ...
	 * </p>
	 *
	 * @return an <code>Iterator</code> containing all of the names of headers
	 *         provided with this file item. If the item does not have any headers
