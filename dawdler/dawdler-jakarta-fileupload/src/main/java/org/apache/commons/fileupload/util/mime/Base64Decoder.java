...
final class Base64Decoder {
	...
	/**
	 * Number of bytes per encoded chunk - 4 6bit bytes produce 3 8bit bytes on
	 * output.
	 */
	...
	/**
	 * Set up the decoding table; this is indexed by a byte converted to an unsigned
	 * int, so must be at least as large as the number of different byte values,
	 ...
	 * @throws IOException thrown when the padding is incorrect or the input is
	 *                     truncated.
	 */
