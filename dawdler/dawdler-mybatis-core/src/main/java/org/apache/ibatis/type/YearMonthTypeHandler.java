 ...
 * <p>
 * YearMonthTypeHandler relies upon {@link java.time.YearMonth#parse
 * YearMonth.parse}. Therefore column values are expected as strings. The format
 * must be uuuu-MM. Example: "2016-08"
 *
 * @since 3.4.5
