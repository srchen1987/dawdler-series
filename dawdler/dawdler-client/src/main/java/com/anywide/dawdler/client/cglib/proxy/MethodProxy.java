...
public class MethodProxy {
	 ...
	 * {@link net.sf.cglib.reflect.FastMethod} class for similar functionality.
	 */
	...
	/**
	 * Return the {@link net.sf.cglib.reflect.FastClass} method index for the method
	 * used by {@link #invokeSuper}. This index uniquely identifies the method
	 * within the generated proxy, and therefore can be useful to reference external
	 * metadata.
	 * 
	 * @see #getSuperName
	 */
	 ...
	 *         found
	 * @throws IllegalArgumentException if the Class was not created by Enhancer or
