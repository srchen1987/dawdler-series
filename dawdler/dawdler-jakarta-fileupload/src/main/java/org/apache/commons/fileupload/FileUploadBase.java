 ...
 * {@link #parseRequest(RequestContext)} to acquire a list of
...
public abstract class FileUploadBase {
	 ...
	 * 
	 * @deprecated This constant is no longer used. As of commons-fileupload 1.2,
	 *             the only applicable limit is the total size of a parts headers,
	 ...
	 *                             error while communicating with the client or a
	 *                             problem while storing the uploaded content.
	 */
	 ...
	 *
	 * @param headers     A <code>Map</code> containing the HTTP request headers.
	 * @param isFormField Whether or not this item is a form field, as opposed to a
	 *                    file.
	 *
	 * @return A newly created <code>FileItem</code> instance.
	 *
	 * @throws FileUploadException if an error occurs.
	 * @deprecated 1.2 This method is no longer used in favour of internally created
	 *             instances of {@link FileItem}.
	 */
	@Deprecated
	...
	private class FileItemIteratorImpl implements FileItemIterator {
		...
		class FileItemStreamImpl implements FileItemStream {
			 ...
			 *                                  which might be an indicator of a security
			 *                                  attack. If you intend to use the file name
		...
		FileItemIteratorImpl(RequestContext ctx) throws FileUploadException, IOException {
			...
			if (sizeMax >= 0) {
				...
				input = new LimitedInputStream(ctx.getInputStream(), sizeMax) {
					@Override
					protected void raiseError(long pSizeMax, long pCount) throws IOException {
						FileUploadException ex = new SizeLimitExceededException(format(
	...
	/**
	 * Thrown to indicate that the request size is not specified. In other words, it
	 * is thrown, if the content-length header is missing or contains the value -1.
	 *
