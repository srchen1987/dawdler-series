...
public class FileCleanerCleanup implements ServletContextListener {
	 ...
	 */
	public static final String FILE_CLEANING_TRACKER_ATTRIBUTE = FileCleanerCleanup.class.getName()
			+ ".FileCleaningTracker";

	/**
	 * Returns the instance of {@link FileCleaningTracker}, which is associated with
