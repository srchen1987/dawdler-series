 ...
 */
package club.dawdler.clientplug.web.validator.injector;

import club.dawdler.clientplug.web.validator.RuleOperatorProvider;
import club.dawdler.clientplug.web.validator.operators.RuleOperator;
...
public class ValidatorInjector implements CustomComponentInjector {
	...
	public String[] scanLocations() {
		return new String[] { "club.dawdler.clientplug.web.validator.operators" };
	}
