...
public class NamingContext implements Context {
	 ...
	 *                                                              mandatory
	 *                                                              attributes
	 * @exception NamingException                                   if a naming
	 *                                                              exception is
	 *                                                              encountered
	 */
	@Override
	 ...
	 *                                  context, or does not name a context of the
	 *                                  appropriate type
	 */
	@Override
	 ...
	 * @exception NameAlreadyBoundException                         if name is
	 *                                                              already bound
	 * @exception javax.naming.directory.InvalidAttributesException if creation of
	 *                                                              the sub-context
	 *                                                              requires
	 *                                                              specification of
	 *                                                              mandatory
	 ...
	 * @exception OperationNotSupportedException if the naming system does not have
	 *                                           the notion of a full name
	 * @exception NamingException                if a naming exception is
	 *                                           encountered
	 */
	@Override
