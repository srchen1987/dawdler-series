...
public final class Streams {
	 ...
	 * </pre>
	 *
	 * @param inputStream       The input stream, which is being read. It is
	 *                          guaranteed, that {@link InputStream#close()} is
	 *                          called on the stream.
	 * @param outputStream      The output stream, to which data should be written.
	 *                          May be null, in which case the input streams
	 *                          contents are simply discarded.
	 * @param closeOutputStream True guarantees, that {@link OutputStream#close()}
	 *                          is called on the stream. False indicates, that only
	 *                          {@link OutputStream#flush()} should be called
	 *                          finally.
	 *
	 ...
	 *                          {@link OutputStream#flush()} should be called
	 *                          finally.
	 * @param buffer            Temporary buffer, which is to be used for copying
	 *                          data.
	 * @return Number of bytes, which have been copied.
	 * @throws IOException An I/O error occurred.
	 */
	 ...
	 * {@link org.apache.commons.fileupload.FileItemStream}'s content into a string.
	 * The platform's default character encoding is used for converting bytes into
	 * characters.
	 *
