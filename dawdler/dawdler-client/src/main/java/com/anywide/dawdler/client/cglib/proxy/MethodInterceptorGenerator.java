...
class MethodInterceptorGenerator implements CallbackGenerator {
	...
	private static final Type METHOD_PROXY = TypeUtils.parseType("com.anywide.dawdler.client.cglib.proxy.MethodProxy");
	private static final Type METHOD_INTERCEPTOR = TypeUtils
			.parseType("com.anywide.dawdler.client.cglib.proxy.MethodInterceptor");
