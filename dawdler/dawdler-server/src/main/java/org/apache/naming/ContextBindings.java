...
public class ContextBindings {
	 ...
	 *
	 * @return <code>true</code> if the current thread is bound to a naming context,
	 ...
	 *
	 * @return <code>true</code> if the thread context class loader or one of its
	 *         parents is bound to a naming context, otherwise <code>false</code>
	 */
