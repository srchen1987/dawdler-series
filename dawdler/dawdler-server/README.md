...
dawdler-server-plug-mybatis中的读写分离也是基于aop实现的,请参考[通过aop切换数据库连接](../dawdler-mybatis-plug/dawdler-mybatis-core/src/main/java/club/dawdler/core/db/mybatis/aspect/SwitchConnectionAspect.java).
