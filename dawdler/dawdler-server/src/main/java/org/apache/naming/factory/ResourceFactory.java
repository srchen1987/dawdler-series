...
public class ResourceFactory extends FactoryBase {
	...
	protected ObjectFactory getDefaultFactory(Reference ref) throws NamingException {
		...
		if (ref.getClassName().equals("javax.sql.DataSource")) {
			String javaxSqlDataSourceFactoryClassName = System.getProperty("javax.sql.DataSource.Factory",
			...
			String javaxMailSessionFactoryClassName = System.getProperty("javax.mail.Session.Factory",
