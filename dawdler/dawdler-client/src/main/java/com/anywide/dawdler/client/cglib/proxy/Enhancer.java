...
public class Enhancer extends AbstractClassGenerator {
	...
	private static final Type FACTORY = TypeUtils.parseType("com.anywide.dawdler.client.cglib.proxy.Factory");
	...
	private static final Type CALLBACK = TypeUtils.parseType("com.anywide.dawdler.client.cglib.proxy.Callback");
	 ...
	 * 
	 * @param interceptDuringConstruction whether to intercept methods called from
	 *                                    the constructor
	 */
	...
	public void generateClass(ClassVisitor v) throws Exception {
		...
		if (currentData == null) {
			e.begin_class(Constants.V1_8, Constants.ACC_PUBLIC, getClassName(), Type.getType(sc),
