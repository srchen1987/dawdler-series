...
public class TextareaControl extends Control {
	...
	protected String replaceContent() {
		...
		sb.append(ControlContent.TEXTAREASTART.replace(ControlContent.CONTROLNAMEREPLACE,controlname).replace(ControlContent.CONTROLTYPEREPLACE, controltype).replace(ControlContent.VIEWNAMEREPLACE,viewname));
		...
		sb.append(">");
		if(value!=null&&!value.trim().equals(""))sb.append(value);
