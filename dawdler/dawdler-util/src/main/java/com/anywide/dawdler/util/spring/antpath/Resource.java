...
public interface Resource extends InputStreamSource {
	 ...
	 * {@link #getInputStream()}.
	 * <p>
	 * Will be {@code true} for typical resource descriptors that exist since it
	 * strictly implies {@link #exists()} semantics as of 5.1. Note that actual
	...
	/**
	 * Determine whether this resource represents a file in a file system. A value
	 * of {@code true} strongly suggests (but does not guarantee) that a
	 * {@link #getFile()} call will succeed.
	 * <p>
