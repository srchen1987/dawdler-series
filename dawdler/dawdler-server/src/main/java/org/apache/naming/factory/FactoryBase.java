...
public abstract class FactoryBase implements ObjectFactory {
     ...
     * @return <code>true</code> if this factory can process the object, otherwise
     * <code>false</code>
     */
    protected abstract boolean isReferenceTypeSupported(Object obj);

    /**
     * If a default factory is available for the given reference type, create the
     * default factory.
     *
     ...
     *
     * @param ref The reference object to be processed
     * @return The linked object or <code>null</code> if linked objects are not
     * supported by or not configured for this reference object
