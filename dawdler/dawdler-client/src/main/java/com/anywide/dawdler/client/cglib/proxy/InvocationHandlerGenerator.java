...
implements CallbackGenerator
{
    ...
    private static final Type INVOCATION_HANDLER =
      TypeUtils.parseType("com.anywide.dawdler.client.cglib.proxy.InvocationHandler");
    private static final Type UNDECLARED_THROWABLE_EXCEPTION =
      TypeUtils.parseType("com.anywide.dawdler.client.cglib.proxy.UndeclaredThrowableException");
