...
![version](https://img.shields.io/badge/dawdler--series-0.1.6--jdk21--RELEASES-brightgreen)&nbsp;
...
#### 25. [dawdler-encrypt-generator](dawdler/dawdler-encrypt-generator/README.md)

用于生成properties与统一配置中心使用加密的密钥工具类.

#### 26. [dawdler-dependencies](dawdler/dawdler-dependencies/README.md)
...
#### 29. [dawdler-service-plug](dawdler/dawdler-service-plug/README.md)
