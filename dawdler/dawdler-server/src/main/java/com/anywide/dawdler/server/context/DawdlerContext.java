...
public class DawdlerContext {
	...
	public DawdlerContext(ClassLoader classLoader,String deployName,String deployPath,String deployClassPath,ServicesManager servicesManager) {
	...
	public static DawdlerContext getDawdlerContext() {
		...
		if(context == null)context = ((DawdlerDeployClassLoader)Thread.currentThread().getContextClassLoader()).getDawdlerContext();
		return context;
	}
