...
public class DataSourceLinkFactory extends ResourceLinkFactory {
	...
	/**
	 * Simple wrapper class that will allow a user to configure a ResourceLink for a
	 * data source so that when {@link javax.sql.DataSource#getConnection()} is
	 * called, it will invoke
