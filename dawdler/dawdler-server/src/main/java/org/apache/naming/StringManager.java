...
public class StringManager {
	...
	/**
	 * Get a string from the underlying resource bundle or return null if the String
	 * is not found.
	 * 
	 * @param key to desired resource String
	 * @return resource String matching <i>key</i> from underlying bundle or null if
	 *         not found.
