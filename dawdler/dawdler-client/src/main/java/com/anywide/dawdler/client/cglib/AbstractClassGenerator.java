package com.anywide.dawdler.client.cglib;
/*
...
abstract public class AbstractClassGenerator<T> implements ClassGenerator {
	...
	protected static class ClassLoaderData {
		 ...
		 * {@link net.sf.cglib.proxy.Enhancer} configuration), and the value is the
		 * generated class plus some additional values (see
	 ...
	 * 
	 * @param classLoader the loader to generate the new class with, or null to use
	 *                    the default
	 */
