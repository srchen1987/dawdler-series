...
class DispatcherGenerator implements CallbackGenerator {
	...
	private static final Type DISPATCHER = TypeUtils.parseType("com.anywide.dawdler.client.cglib.proxy.Dispatcher");
	private static final Type PROXY_REF_DISPATCHER = TypeUtils
			.parseType("com.anywide.dawdler.client.cglib.proxy.ProxyRefDispatcher");
