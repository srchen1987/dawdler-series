...
public enum AutoMappingUnknownColumnBehavior {
	 ...
	 * {@code 'org.apache.ibatis.session.AutoMappingUnknownColumnBehavior'} must be
	 * set to {@code WARN}.
	 */
	WARNING {
		@Override
	...
	/**
	 * Perform the action when detects an unknown column (or unknown property type)
	 * of automatic mapping target.
	 * 
	 ...
	 * @param propertyType    property type for mapping target (If this argument is
	 *                        not null, {@link org.apache.ibatis.type.TypeHandler}
